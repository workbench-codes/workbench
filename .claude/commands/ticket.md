...
Thin wrapper that bootstraps context and spawns the ticketer agent.
...
3. **Spawn the ticketer agent** via the Agent tool:
   ...
   - Include in the prompt:
     ...
     - `Read .workbench/workflow/agents/ticketer.body.md and follow those instructions for issue {issue_id}.`
